...
from .models import Student, Trainer, Interview
...
class InterviewRequestWithMockData(TestCase):
    def test_valid_data_no_slots(self):
        ...
        self.assertEqual(content_json["interview"], False)

    def test_max_interviews_exceeded(self):
        old_value = Constants.MAX_INTERVIEWS_ALLOWED
        ...
        Constants.MAX_INTERVIEWS_ALLOWED = old_value
